...
"""
__version__ = '$Id: barchart.py,v 1.2 2005-04-13 08:26:15 orlando Exp $'
...
barfiles = {  'blue' : 'bar-blue.gif',
               'red' : 'bar-red.gif',
             'green' : 'bar-green.gif',
            'orange' : 'bar-orange.gif',
            'yellow' : 'bar-yellow.gif',
            'purple' : 'bar-purple.gif'  }
